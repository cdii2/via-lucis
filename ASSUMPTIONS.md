...
- A171 (2026-07-16, Wave E1, we/polish): **API.md gets a new `## Shows`
...
- A170 (2026-07-16, Wave E1, we/polish): **`GET /api/songs`'s `parseOk`
...
- A169 (2026-07-16, Wave E1, we/polish): **unison-note color precedence
...
- A168 (2026-07-16, Wave E1, we/polish): **effect buffer write guards
...
- A167 (2026-07-16, Wave E1, we/polish): **`idleSec` (§3-E item 9) — KEEP,
...
- A166 (2026-07-16, Wave E1, we/polish): **`mode` omitted from statusJson
...
- A165 (2026-07-16, Wave E1, we/polish): **hex color strictness (§3-E item
  ...
  to apply on `we/ble`.
- A164 (2026-07-16, Wave E1, we/polish): **palette reset on
  ...
  is correct for both).
- A163 (2026-07-16, Wave E1, we/polish): **`formatVersion` in `GET
...
- A162 (2026-07-16, Wave E1, we/polish): **CORS added to `POST
...
- A161 (2026-07-16, Wave E1, we/polish): **405-for-wrong-method (§3-E item
...
- A160 (2026-07-16, Wave E1, we/polish): **Load-nonexistent-song → 404
